...
-- newT cant_bahias altura_bahias ruta = Tru (replicate cant_bahias (newS altura_bahias)) ruta

--POSIBLE MEJORA: no permitir la creacion de camiones con cantidad de bahias o altura de las bahias 0 o negativa
